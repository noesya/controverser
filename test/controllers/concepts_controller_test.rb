...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference("Concept.count") do
      post concepts_url, params: { concept: { description: @concept.description, name: @concept.name, slug: @concept.slug } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { description: @concept.description, name: @concept.name, slug: @concept.slug } }
